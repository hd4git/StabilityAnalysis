library(data.table)
library(ggplot2)
setwd("/data/borth/hdhiman/janssen/integration_sites/filter_regions/src2/exp/bg")

list<-read.table("/data/borth/hdhiman/janssen/integration_sites/filter_regions/src2/list_exp_bg.txt", header=FALSE)
